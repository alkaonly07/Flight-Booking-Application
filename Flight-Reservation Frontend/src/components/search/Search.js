                ...
                <div className="card-body">
                  ...
                  <div className="form-group">
                      <label > Origin City : </label>
                          ...
                          <select style={{width: '50rem', height: '3rem'}}
                        placeholder="Enter origin city" name="origin city" className="form-select "
                        
                          onChange={(e) => setOriginCity(e.target.value)} >
                            
                          <option selected>Enter origin city</option>
                  ...
                  /> */}
                    ...
                    <div className="form-group">
                      <label > Destination City : </label>
                          ...
                          <select style={{width: '50rem', height: '3rem'}}
                        placeholder="Enter destination city" name="destination city" className="form-select "
                        
                          onChange={(e) => setDestinationCity(e.target.value)} >
                            
                          <option selected>Enter destination city</option>
                            <option>Bangalore-BLR</option>
                            <option>Delhi-DEL</option>
                            <option>Hyderabad-HYD</option>
                            <option>Kolkata-CCU</option>
